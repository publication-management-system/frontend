...
import type { Project, ProjectTaskColumn, Task, TaskState } from "../../../data/project.ts";
    ...
    const onCreateTask = () => {
        openModal(
            ...
            <CreateTaskForm
                ...
                onError={(err) => {
                    setToastSettings({ open: true, message: err, type: "error" });
                }}
                projectId={projectId ?? ""}
            />,
        );
