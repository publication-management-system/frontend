...
import type { UserData, UserName } from "../../../data/user.ts";
...
export const SettingsPage = (): React.JSX.Element => {
    ...
    const loadCurrentUser = async (): Promise<void> => {
        const resp = await authenticatedClient
            .get(`/api/users/${getUserInfo().userId}`)
                        ...
                        <div className={"content"}>
                            <Card className="profile-card">
                                <ProfileImage
                                    ...
                                    onClick={openModalUploadProfileImage}
                                />
                                <h1>
