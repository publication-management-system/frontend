...
import type { UserName } from "../../../data/user.ts";
...
export const AccountDetailsCard = (props: AccountDetailsProps) => {
    ...
    const updateName = async () => {
        await authenticatedClient
            .patch(`/api/users/${props.userId}/name`, {
        ...
        <Card className={`edit-details-card`}>
            <Form onSubmit={updateName}>
                ...
                <Input
                    ...
                    label={"First name"}
                    onChange={(newVal) => {
                        setUserName({ ...userName, firstName: newVal.target.value });
                    }}
                />
                <Input
                    ...
                    label={"Middle name"}
                    onChange={(newVal) => {
                        setUserName({ ...userName, middleName: newVal.target.value });
                    }}
                />
                <Input
                    ...
                    label={"Last name"}
                    onChange={(newVal) => {
                        setUserName({ ...userName, lastName: newVal.target.value });
                    }}
                />
                <div>
