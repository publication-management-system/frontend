...
import type { UpdatePassword } from "../../../data/user.ts";
...
export const UpdatePasswordCard = (props: UpdatePasswordCardProps): React.JSX.Element => {
    ...
    const changePassword = () => {
        authenticatedClient
            .patch(`/api/users/${props.userId}/password`, { ...password })
            .then(() => {
                props.onSuccess();
        ...
        <Card className={"edit-details-card"}>
            <Form onSubmit={changePassword}>
                ...
                <Input
                    ...
                    onChange={(val) => {
                        setPassword({ ...password, currentPassword: val.target.value });
                    }}
                />
                <Input
                    ...
                    label={"New Password"}
                    onChange={(val) => {
                        setPassword({ ...password, newPassword: val.target.value });
                    }}
                />
                <Input
                    ...
                    onChange={(val) => {
                        setPassword({ ...password, confirmPassword: val.target.value });
                    }}
                />
                <div>
